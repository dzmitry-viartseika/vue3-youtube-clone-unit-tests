...
import TheSearchPredictionCategories from './TheSearchPredictionCategories';
...
it('shows search prediction categories unchecked', () => {
    ...
    categories.forEach((category) => expect(screen.getByLabelText(category).checked).toBe(false))
